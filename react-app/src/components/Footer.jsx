...
export default function Footer() {
  return (
    <>
    <footer className='block md:hidden text-white flex flex-col justify-center items-center bg-gradient-to-br from-[#385894] via-[#473CE0] to-[#682FD8]'>
    {/*Mobile Version*/}
      <div className="block md:hidden team-info w-[70%] p-8 flex justify-center flex-col items-center">
        <div className="block md:hidden footer-bold flex justify-between w-full pb-4">
          ...
          <div className="block md:hidden name-container flex w-full pb-4 justify-between">  
            ...
            <p className="block md:hidden w-1/4 text-left"><a href="https://www.linkedin.com/in/mjleedesigners" target='_blank'>Myoungjin L.</a></p>
          </div>
          ...
          <div className="block md:hidden name-container flex w-full justify-between md:flex-col">
            ...
            <p className="block md:hidden w-1/4 text-left"><a href="https://linkedin.com/in/james-nwumfor-56008144" target='_blank'>James N.</a></p>
          </div>
      </div>
      ...
      <div className="desktop-name-container w-1/2">
        <div className="credit-list-container p-6">
          ...
          <div className="credit flex pb-[7px] pb-[7px]">
            ...
            <a className="text-[21px] border-b border-b-[1px] border-white/50 flex items-center justify-center" href="https://linkedin.com/in/james-nwumfor-56008144" target='_blank'><FaLinkedin /></a>
          </div>
          ...
          <div className="credit flex pb-[7px]">
            ...
            <a className="text-[21px] border-b border-b-[1px] border-white/50 flex items-center justify-center" href="https://www.linkedin.com/in/mjleedesigners" target='_blank'><FaLinkedin /></a>
          </div>
        </div>
      </div>
    </div>
