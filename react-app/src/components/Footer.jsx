      ...
      <header className="border-2 whitespace-normal break-words">
        ...
        <ul className="p-4">
          ...
          <li>
            ...
            /{' '}
            <a
              href="https://www.linkedin.com/in/valerielabideveloper/"
              target="_blank"
            >
              LinkedIn
            </a>
          ...
          <li>
            ...
            /{' '}
            <a
              href="https://www.linkedin.com/in/molly-b-97877492/"
              target="_blank"
            >
              LinkedIn
            </a>
          ...
          <li>
            Jim Schibler:
            <a href="https://github.com/jaschibler" target="_blank">
              GitHub
            </a>{' '}
            /{' '}
          ...
          <li>
            ...
            /{' '}
            <a
              href="https://www.linkedin.com/in/james-nwumfor-56008144/"
              target="_blank"
            >
              LinkedIn
            </a>
